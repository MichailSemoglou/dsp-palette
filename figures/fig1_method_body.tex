% fig1_method_body.tex — tikzpicture only (no document class).
% \input{figures/fig1_method_body} inside the paper's figure* environment.
\begin{tikzpicture}[
...
\node[note, above=3mm of out] {$n$ swatches\\+ roles};
