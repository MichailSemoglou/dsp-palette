...
**WCAG AA contrast ratio:** Relative luminance Y computed as per W3C WCAG 2.1 §1.4.3 (linearise sRGB channel c: c/12.92 if c≤0.04045, else ((c+0.055)/1.055)^2.4; then Y = 0.2126R + 0.7152G + 0.0722B). Contrast ratio = (Y_lighter + 0.05) / (Y_darker + 0.05). AA pass threshold: ratio ≥ 4.5 (normal text). WCAG AA Coverage = fraction of ordered colour pairs in the palette that meet this threshold. Reference: W3C, *Web Content Accessibility Guidelines (WCAG) 2.1*, https://www.w3.org/TR/2025/REC-WCAG21-20250506/, 2025.
